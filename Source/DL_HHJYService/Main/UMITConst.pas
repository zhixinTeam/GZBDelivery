...
type
  TSysParam = record
    ...
    FERPSrvOms             : string;                    //ERPOms接口地址
    FToken                 : string;                    //ERP对应Token
    FTokenOms              : string;                    //ERPOms对应Token
    FshipperCode           : string;                    //发货客户编码
    FshipperName           : string;                    //发货客户名称
    FshipperContactCode    : string;                    //发货联系人编码
    FshipperContactName    : string;                    //发货联系人名称
    FshipperContactTel     : string;                    //发货联系电话
    FshipperLocationCode   : string;                    //发货地点编码
    FshipperLocationName   : string;                    //发货地点名称
    FconsigneeCode         : string;                    //收货客户编码
    FconsigneeName         : string;                    //收货客户名称
    FconsigneeContactCode  : string;                    //收货联系人编码
    FconsigneeContactName  : string;                    //收货联系人名称
    FconsigneeContactTel   : string;                    //收货联系电话
    FconsigneeLocationCode : string;                    //收货地点编码
    FconsigneeLocationName : string;                    //收货地点名称
    ForgId                 : string;                    //所在公司
