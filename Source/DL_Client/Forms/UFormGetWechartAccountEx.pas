...
type
  ...
  TfFormGetWechartAccountEx = class(TfFormNormal)
    cxLabel1: TcxLabel;
...
class function TfFormGetWechartAccountEx.CreateForm(const nPopedom: string;
...
begin
  ...
  with TfFormGetWechartAccountEx.Create(Application) do
  try
    Caption := '选择账号';
...
class function TfFormGetWechartAccountEx.FormID: integer;
begin
  Result := cFI_FormGetWXAccount;
end;

procedure TfFormGetWechartAccountEx.FormCreate(Sender: TObject);
begin
  LoadFormConfig(Self);
end;

procedure TfFormGetWechartAccountEx.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  SaveFormConfig(Self);
end;

procedure TfFormGetWechartAccountEx.Timer1Timer(Sender: TObject);
begin
...
procedure TfFormGetWechartAccountEx.EditNamePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  EditName.Text := '';
end;

procedure TfFormGetWechartAccountEx.EditNamePropertiesChange(Sender: TObject);
begin
  LoadCustomer(EditName.Text);
end;

//------------------------------------------------------------------------------
procedure TfFormGetWechartAccountEx.LoadCustomerList;
var nIdx: Integer;
begin
...
procedure TfFormGetWechartAccountEx.LoadCustomer(nFilter: string);
...
procedure TfFormGetWechartAccountEx.EditNameKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfFormGetWechartAccountEx.EditNameKeyDown(Sender: TObject;
...
procedure TfFormGetWechartAccountEx.BtnOKClick(Sender: TObject);
begin
  if ListQuery.ItemIndex < 0 then
...
initialization
  gControlManager.RegCtrl(TfFormGetWechartAccountEx, TfFormGetWechartAccountEx.FormID); 
end.
